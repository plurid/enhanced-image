...
class EnhancedImageButtonCheckmark {
    ...
    static get style() { return ".enhanced-image-button-checkmark{cursor:pointer;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:justify;justify-content:space-between;padding:7px 10px}.enhanced-image-button-checkbox{display:block;height:10px;width:10px;border-radius:50%;border:2px solid #fff;background-color:#4b4c4e}.enhanced-image-button-checkbox-fill{background-color:#fff}"; }
}
...
class EnhancedImageButtonItem {
    ...
    static get style() { return ".enhanced-image-button-item{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;padding:7px 10px;cursor:pointer}.enhanced-image-button-icon{height:16px;width:16px;margin-right:4px;padding:6px;padding-left:0}.enhanced-image-button-icon svg{width:16px}"; }
}
...
class EnhancedImageSettingsList {
    ...
    static get style() { return "\@import url(\"https://fonts.googleapis.com/css?family=Didact+Gothic\");.enhanced-image-settings-list ul{display:-ms-flexbox;display:flex;background-color:#323334;color:#fff;-webkit-box-shadow:0 0 5px 0 #000;box-shadow:0 0 5px 0 #000;list-style:none;padding:0;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-size:14px;min-width:190px;border-radius:10px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol}.enhanced-image-settings-list-topleft ul,.enhanced-image-settings-list-topright ul,.enhanced-image-settings-list ul{-ms-flex-direction:column;flex-direction:column}.enhanced-image-settings-list-bottomleft ul,.enhanced-image-settings-list-bottomright ul{-ms-flex-direction:column-reverse;flex-direction:column-reverse}.enhanced-image-settings-list-topleft ul li:first-child,.enhanced-image-settings-list-topright ul li:first-child{border-top-left-radius:10px;border-top-right-radius:10px}.enhanced-image-settings-list-bottomleft ul li:first-child,.enhanced-image-settings-list-bottomright ul li:first-child,.enhanced-image-settings-list-topleft ul li:last-child,.enhanced-image-settings-list-topright ul li:last-child{border-bottom-left-radius:10px;border-bottom-right-radius:10px}.enhanced-image-settings-list-bottomleft ul li:last-child,.enhanced-image-settings-list-bottomright ul li:last-child{border-top-left-radius:10px;border-top-right-radius:10px}.enhanced-image-settings-list ul li:hover{background-color:#4b4c4e}.enhanced-image-settings-list ul li a{color:#fff;text-decoration:none}.enhanced-image-settings-list-button{cursor:pointer}.enhanced-image-settings-list-value{margin-top:10px}.enhanced-image-hr{border:none;border-top:1px solid #7d7f82;margin:0}.enhanced-image-button-default{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;padding:7px 10px;min-height:28px}.enhanced-image-location{-ms-flex-pack:justify;justify-content:space-between}.enhanced-image-location-spans{display:inline-grid;grid-gap:8px;grid-template-columns:1fr 1fr 1fr 1fr}.enhanced-image-location-span{height:16px;width:16px;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;cursor:pointer;border-radius:12px;border:2px solid transparent}.enhanced-image-location-span svg{height:8px;width:8px}.enhanced-image-location-span-active,.enhanced-image-location-span:hover{border:2px solid #fff}"; }
}
...
class EnhancedImageSliderItem {
    ...
    static get style() { return ".enhanced-image-slider-item-container{padding:7px 10px}.enhanced-image-slider-container{width:100%;margin-top:3px;margin-bottom:7px}.enhanced-image-slider{-webkit-appearance:none;width:100%;height:3px;margin:0;border-radius:1.5px;outline:none}.enhanced-image-slider::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:15px;height:15px;border-radius:50%;border:2px solid #fff;background-color:#4b4c4e;cursor:pointer}.enhanced-image-slider::-moz-range-thumb{width:15px;height:15px;border-radius:50%;border:2px solid #fff;background-color:#4b4c4e;cursor:pointer}.enhanced-image-slider-value{float:right;font-size:12px}"; }
}
