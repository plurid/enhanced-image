...
class EnhancedImageSettings {
    ...
    static get style() { return ".enhanced-image-settings-container{display:grid;-ms-flex-align:center;align-items:center}.enhanced-image-settings-container-topright{justify-items:right}.enhanced-image-settings-container-topleft{justify-items:left}.enhanced-image-settings-container-bottomright{justify-items:right}.enhanced-image-settings-container-bottomright enhanced-image-settings-button{grid-row:2}.enhanced-image-settings-container-bottomleft{justify-items:left}.enhanced-image-settings-container-bottomleft enhanced-image-settings-button{grid-row:2}"; }
}
...
class EnhancedImageSettings$1 {
    ...
    static get style() { return ".enhanced-image-settings-button{cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;height:30px;width:30px}.enhanced-image-settings-button svg{height:30px;width:30px;-webkit-filter:drop-shadow(0 0 3px #323334);filter:drop-shadow(0 0 3px hsl(220,2%,20%))}"; }
}
